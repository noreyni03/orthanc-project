              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border ${error?.toLowerCase().includes('nom') ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm`}
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    disabled={loading || googleLoading}
                    className={`block w-full pl-10 pr-3 py-3 border ${error?.toLowerCase().includes('email') ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm`}
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    disabled={loading || googleLoading}
                    className={`block w-full pl-10 pr-10 py-3 border ${error?.toLowerCase().includes('passe') ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm`}
                    placeholder="••••••••"
                  />
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    disabled={loading || googleLoading}
                    className={`block w-full pl-10 pr-10 py-3 border ${error?.toLowerCase().includes('correspondent') ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm`}
                    placeholder="••••••••"
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                    <button
